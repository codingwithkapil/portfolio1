    ...
    <>
      ...
      <Layout className='pt-0 md:p-16 sm:p-8'>
        ...
        <div className='w-1/2 md:w-full'>
          <Image src={profilePic} alt="TechSharma" className="w-full h-auto lg:hidden md:inline-block md:w-full" 
          priority
        ...
        <div className='w-1/2 flex-col items-center self-center lg:w-full lg:text-center '>
          ...
          xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl'/>
            ...
            <div className='flex item-center self-start mt-2 lg:self-center'>
              ...
              <Link href="mailto:kapil.sharma@techsharma.com" target={"_blank"}
              className='ml-4 text-lg font-medium capitalize text-dark underline dark:text-light'>Contect</Link>
            </div>
        </div>
        </div>
      </Layout>
      ...
      <div className='absolute right-8 bottom-8 inline-block w-24 md:hidden'>
        <Image src={lightBulb} alt="TechSharma" className='w-full h-auto'/>
      </div>
      </main>
    </>
  )
